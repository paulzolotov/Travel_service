    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(default=True, verbose_name="Is it active?"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=70, verbose_name="Direction Name"),
                ),
                (
                    "start_point",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "car",
                    models.CharField(
                        default="Mercedes-Benz Sprinter",
                        max_length=80,
                ...
                (
                    "direction",
                    models.ForeignKey(
                        default=booking.models.Direction.get_default_direction_pk,
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="booking.direction", verbose_name="Direction Name"
            ),
        ),
    ]
